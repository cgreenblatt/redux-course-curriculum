...
export default function Tweet({ tweet }) {
  ...
  const handleLikeTweet = () => dispatch(toggleLikeTweet(tweet.id, authedUser));
    ...
    <div className="tweet">
      ...
      <div className="tweet-info">
        ...
        <div className="tweet-icons">
          ...
          <button className="heart-button" onClick={handleLikeTweet}>
            {tweet.likes.includes(authedUser) ? heartIconFilled : heartIcon}
          </button>
